...
from metaevobox.baseline.metabbo.networks import MultiHeadEncoder, MLP, EmbeddingNet
from metaevobox.rl.ppo import *
...
class Actor(nn.Module):
    ...
    def __init__(self,
        ...
        mlp_config = [{'in': self.embedding_dim, 'out': hidden_dim1, 'drop_out': 0, 'activation': 'LeakyReLU'},
                      ...
                      {'in': hidden_dim2, 'out': 3, 'drop_out': 0, 'activation': 'None'}]
